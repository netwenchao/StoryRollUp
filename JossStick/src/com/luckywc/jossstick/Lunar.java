...
public class Lunar {
    ...
    final static String EnMonth[]={"Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sept","Oct","Nov","Dec"};
    final static String Big_Or_Small[] ={ "大", "小", "大", "小", "大", "小", "大", "大", "小", "大", "小", "大" };
    private String[] LunarHolDayName ={ "小寒", "大寒", "立春", "雨水", "惊蛰", "春分", "清明", "谷雨", "立夏", "小满", "芒种", "夏至",
    ...
    public Lunar(Calendar cal)
    {
        ...
        try
        {
            baseDate = (Date) chineseDateFormat.parse(" 1900年1月31日 ");
        }
    ...
    public String get_En_Month(){
    	if(this.month>0 && this.month<13)
    		return EnMonth[this.month-1];
    	return "";
    }
